...
<div class="eventview-infos">
    ...
    par <a href="<?php echo $this->url('user_profil', ['id' => $event['users_id']]) ?>">Assoc/comp</a>
    </div>
    ...
    <div>
        <h3>Qui participe ?</h3>
        <a href="<?php echo $this->url('user_profil', ['id' => $event['guest_part_id']]) ?>">Participant</a>
    </div>
...
<div class="eventview-comments">
  ...
  <div id="add_new_comment" data-event-id="<?php echo $event['id']?>">
    ...
    <div class="comment">
        ...
        <button class="add_answer_comment"><i class="fa fa-plus-circle" aria-hidden="true"></i> Répondre</button>
